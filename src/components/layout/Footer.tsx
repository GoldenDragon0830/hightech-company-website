    ...
    <footer className="site-footer">
      <div className="shell">
        <Reveal className="footer-grid">
          <div className="footer-intro">
            ...
            <a className="text-link" href={site.github} target="_blank" rel="noopener noreferrer">
              Find us on GitHub <ArrowUpRight size={15} />
            </a>
          </div>
          <div>
            <h2>Explore</h2>
            ...
            <ul>
              ...
              <li>
                <a href={site.calendly} target="_blank" rel="noopener noreferrer">
                  Book a conversation <ArrowUpRight size={14} />
                </a>
              </li>
            </ul>
        ...
        <div className="footer-bottom">
          ...
          <span>Small team. High standards.</span>
          <Link to="/contact">
            Contact & privacy information <ArrowUpRight size={13} />
          </Link>
        </div>
      </div>
    </footer>
