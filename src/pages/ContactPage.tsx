...
const faqs = [
  {
    ...
    answer:
      'No. Preparing a draft only formats your brief on this page. Open your email app, review the recipient, subject and message, then press Send. This website cannot confirm whether you sent an email or whether it was delivered.',
  },
  {
    question: 'What should I include in a first message?',
    answer:
      'Tell us what you want to make or improve, who will use it, and what exists today. A rough timeline and any technical constraints help. Budget is optional, and the ranges in this form are context for a conversation—not a quote or a minimum project size.',
  },
  {
    question: 'Can I attach files?',
    answer:
      'Add attachments in your email app after opening the draft. This form does not upload files. Start with a short, non-confidential overview; agree a suitable sharing process with us before sending proprietary code, credentials or personal data.',
  },
  {
    question: 'What if the email link does not open?',
    answer:
      'Your browser needs a configured email app to open mailto links. Use Copy briefing instead, open your preferred email service, and paste the text into a new message. The briefing includes our email address and a suggested subject. If automatic copying is blocked, use Select briefing text and your device’s Copy command.',
  },
  {
    question: 'How soon can a project start?',
    answer:
      'Timing depends on the scope and current availability. Share any deadline in your brief so it can be discussed before agreeing on work. Submitting an email or scheduling a conversation does not reserve a start date or create a project agreement.',
  },
];
